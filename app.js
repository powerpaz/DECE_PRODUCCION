...
function exportToExcel() {
  try {
    ...
    // Asignaciones según estado actual del mapa (buffers, selección, etc.)
    ...
    const isSatelliteRow = (r) => {
      ...
      if (c === '') return false;
      const n = Number(c);
      // En datasets típicos: 0 o 2 suelen ser satélite
      return n === 0 || n === 2;
    };
    ...
    const rows = rawRows.map(r => {
      ...
      if (amie && isSatelliteRow(r) && isFiscalInstitution(r) && isSatellite51to120(r)) {
    ...
    showNotification("✅ Exportación lista (Resultados_prototipo / Registros_GIEE).", "success");
  } catch (e) {
