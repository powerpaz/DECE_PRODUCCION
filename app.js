...
function exportToExcel() {
  ...
  // (Hoja 'Buffers' removida por requerimiento)

  // (Hoja 'Instituciones' removida por requerimiento)
...
function setupEditControls() {
  ...
  // Exportar Resultados: dejamos SOLO el botón del dashboard (panel KPI) para evitar duplicados.
...
function updateOrphanPanel() {
  ...
  panel.innerHTML = `
    ...
    <div style="grid-column: 1/-1; display:flex; justify-content:center; margin-top: 6px;">
      <button id="btnExportResultsPanel" class="btn-analysis" style="width:100%; max-width: 320px; padding: 12px 14px; border-radius: 12px; font-weight: 600;">
        📤 Exportar Resultados
      </button>
    </div>
  `;

  // El botón se crea dinámicamente dentro del panel, por eso el listener va aquí.
  document.getElementById('btnExportResultsPanel')?.addEventListener('click', showExportModal);
