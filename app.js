...
function enableBufferEditing() {
  ...
  // En edición, deshabilitar el arrastre del mapa para que el click/drag se aplique a los buffers.
  try { map.dragging.disable(); } catch (e) {}
  bindEditPanKeyHandlers();
  // Cursor “listo para mover” (el buffer cambia a move al hover vía CSS opcional)
  try { map.getContainer().style.cursor = 'default'; } catch (e) {}
  showNotification("Modo edición: arrastra buffers. Mantén ESPACIO para mover el mapa.", "info");
