...
const ORPHAN_BUFFER_NUCLEO_MAX_M = 7500; // 7.5 km: máximo satélite→núcleo (solo fiscales/seleccionados) para cubrir buffers B#
const ORPHAN_MAX_DISTANCE_M = 7500; // corte duro: no conectar si supera 7.5 km
