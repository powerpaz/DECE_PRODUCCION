...
// ========== BARRIDO INTELIGENTE ==========
function smartBufferCleanup(nucleos, satellites, satCandidates, selected) {
...
function smartOrphanCoverage(nucleos, satellites, satCandidates, selected) {
...
function setCoverGreedy(nucleos, satellites, satCandidates) {
  ...
  const cleanedSelected = smartBufferCleanup(nucleos, satellites, satCandidates, selected);
  
  // OPTIMIZACIÓN 2: Cobertura de huérfanos (activar núcleos cercanos)
  const optimizedSelected = smartOrphanCoverage(nucleos, satellites, satCandidates, cleanedSelected);
