...
// ✅ Satélites fiscales: usar TODOS (deben cuadrar con el total del dashboard)
let satellites = satellitesAll;
console.log(`[FILTER] Satélites fiscales: ${satellites.length}/${satellitesAll.length}`);
