...
function exportToExcel() {
  ...
  // Nota: La hoja "Buffers" ya no se exporta (solo se mantiene la exportación del dashboard principal).
  ...
  // Nota: La hoja "Instituciones" ya no se exporta (solo se mantiene la exportación del dashboard principal).
